...
<a class="back" href="<?=$this->config->item('base_url')?>main/tour/1/" title="Назад">&laquo; Назад</a>
<a class="next" href="<?=$this->config->item('base_url')?>main/tour/3/" title="Продолжить">Дальше &raquo;</a>
</div>