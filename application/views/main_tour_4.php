...
<a class="back" href="<?=$this->config->item('base_url')?>main/tour/3/" title="Назад">&laquo; Назад</a>
<a class="next" href="<?=$this->config->item('base_url')?>main/tour/5/" title="Продолжить">Дальше &raquo;</a>
</div>