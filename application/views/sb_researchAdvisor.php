<div class="dynamic" id="">
    ...
    <div class="content">
    	<ul class="researchLeftMenu">
    		<li class="scientists">Ученые: <?=floor($this->User_Model->scientists)?></li>
        	<li class="points">Баллы науки: <?=floor($this->User_Model->research->points)?></li>
        	<li class="time">в час: <?=floor($this->User_Model->scientists)?></li>
        </ul>
    </div>
