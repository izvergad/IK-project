...
<a class="back" href="<?=$this->config->item('base_url')?>main/tour/2/" title="Назад">&laquo; Назад</a>
<a class="next" href="<?=$this->config->item('base_url')?>main/tour/4/" title="Продолжить">Дальше &raquo;</a>
</div>