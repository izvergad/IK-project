...
<?if($this->User_Model->register_complete == 0 and $this->config->item('game_email')){?>
      ...
      <div id="options_userData">
        <table cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td><input class="textfield" type="text" name="name" size="15" value="<?=$this->User_Model->login?>"></td>
          </tr>
        ...
        <tr>
            ...
            <td>
                <select name="citySelectOptions" size="1">
                    <option value="0" <?if($this->User_Model->options['city_select'] == 0){?>selected="selected"<?}?>>Нет</option>
                    <option value="1" <?if($this->User_Model->options['city_select'] == 1){?>selected="selected"<?}?>>Показать координаты в обзоре городов</option>
                    <option value="2" <?if($this->User_Model->options['city_select'] == 2){?>selected="selected"<?}?>>Товары</option>
                    </select>
                </td>
            </tr>
<?if($this->User_Model->tutorial < 999){?>
        <tr>
            <th>Обучение</th>
            <td>
...
<?}?>
      ...
      <table cellpadding="0" cellspacing="0">
        <tr>
          <th>Player-ID:</th>
          <td> <?=$this->User_Model->id?></td>
        </tr>
        <tr>
          <th>Current City-ID: </th>
          <td><?=$this->Town_Model->id?></td>
        </tr>
      </table>
      </div>
    ...
    <div class="content">
      ...
      <tr>
            ...
            <td>
                                <input class="textfield" type="text" name="email" size="30" value="<?=$this->User_Model->email?>">
