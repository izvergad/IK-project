...
<?
    if (($i == 1 and $this->User_Model->research->res4_3 > 0) or // 4
        ...
        ($i == 7 and $this->User_Model->research->res4_11 > 0)){ // 9
?>
<?$class = $this->Data_Model->army_class_by_type($i)?>
    <td><?=$this->User_Model->armys[$this->Town_Model->id]->$class?></td>
<?}else{?>
    <td>-</td>
<?}?>
<?}?>
...
<?for($i = 8; $i <= 14; $i++){?>
<?
    if (($i == 8 and $this->User_Model->research->res4_4 > 0) or // 3
...
<?
    if (($i == 16) or
        ...
        ($i == 19 and $this->User_Model->research->res1_2 > 0)){
?>
<?$class = $this->Data_Model->army_class_by_type($i)?>
    <td><?=$this->User_Model->armys[$this->Town_Model->id]->$class?></td>
<?}else{?>
...
<?for($i = 20; $i <= 22; $i++){?>
<?
    if (($i == 20 and $this->User_Model->research->res1_9 > 0) or
