		...
		<div class="content">
			...
			<div id="mapShortcutInput"  style="position:relative;" title="Ссылки острова">
				...
				<select id="homeCitySelect"
                            ...
                            <option value="<?=$this->Island_Model->island->x?>:<?=$this->Island_Model->island->y?>"  selected="selected">[<?=$this->Island_Model->island->x?>:<?=$this->Island_Model->island->y?>] <?=$this->Town_Model->name?></option>                        </select>
