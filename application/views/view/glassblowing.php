...
?>
    <div class="contentBox01h">
        ...
        <h3 class="header"><span class="textLabel">Добыча хрусталя</span></h3>
        <div class="content">
            <table cellspacing="0" cellspacing="0" border="0" style="margin:0 auto 0px;">
                ...
                <tr class='alt'>
                    <td class="col1Style">
                        <label>Стеклодувная Мастерская: </label>
                    </td>
                    <td class="col2Style">
                        <span title="Стеклодувная Мастерская"><?=number_format($bonus)?></span>
                    </td>
                    <td class="col3Style">
