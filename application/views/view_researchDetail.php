<?
    ...
    $next_data = $this->Data_Model->get_research($way,$id+1,$this->User_Model->research);
    if ($data['need_way'] > 0 and $data['need_id'] > 0 )
    {
        $need_data = $this->Data_Model->get_research($data['need_way'],$data['need_id'],$this->User_Model->research);
    }
    switch($way)
    {
    ...
    $time = ($data['points']/$this->User_Model->scientists)*3600;
