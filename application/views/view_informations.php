...
<div class="content">Икариам -это онлайн игра, в которую можно играть с помощью браузера. Каждой народностью острова, которую Вы встретите, управляет другой игрок. Т.е. нет никаких компьютерных врагов. Сама игра непрерывна, то есть даже если Вы закрыли браузер, жизнь в Икариам не останавливается. Ваши исследователи продолжают совершать новые открытия, а рабочие - производить ресурсы.</div><div class="hint">Подсказка: При возвращении в игру после долгого отсутствия Ваши советники сообщат Вам все свежие новости.</div>        <div class="navigation">
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td width="50%" align="left">
...
<div class="content">В Икариам есть два типа ресурсов - строительный материал и добываемые ресурсы. Строительный материал используется в различных целях:</div><div class="list">
                <ul>
...
<div class="content">В Икариам имеются 4 различных типа ресурсов: вино, мрамор, хрусталь и сера. Ресурсы доступны только тогда, когда Вы исследовали Благосостояние (Экономика). Каждый остров обладает только одним источником ресурсов. Каждый ресурс имеет свое собственное применение:</div><div class="list">
                <ul>
...
<div class="contentWithImage" style="display:table"><img style="float:right;" alt ="" src="<?=$this->config->item('style_url')?>skin/research/area_military.jpg">В Икариам есть два различных типа сражений: Морские, где военные корабли борются друг против друга, сухопутные, где идет сражение наземных войск, экипированных военным оборудованием.</div><h2>Божественная защита.</h2><div class="content">Для облегчения игры, новые игроки в мире Икариам не могут быть атакованы. Вы можете увидеть, что защита активирована возле имени города на карте острова.</div><div class="content">Защита заканчивается когда: <br/><ul><li>Ратуша улучшается до уровня 4. (уровня 6 при активации премиум-аккаунта)</li><li>Игрок отправляет войска на атаку другого игрока.</li><li>Основывается первая колония (В момент прибытия кораблей) </li><li> Игрок становится не активным.</li></ul></div><h2>Сценарии</h2><div class="content">Вообще, сражение может начаться одним из двух способов: Первый - атака через город игрока (находящийся на этом же острове), и второй - через морское проникновение (когда цель находится на другом острове).</div><div class="content">Атаки, выполненные сквозь чужие города, приводят к сражениям между атакующим и размещенными солдатами и/или военной аммуницией в этих городах.</div><div class="content">Перед атакой через морское проникновение, необходимо удостовериться, что у противника нет флота в гавани для обороны. Если дело обстоит так, то ваши торговые суда могут быть перехвачены солдатами и в худшем варианте развития событий, они могут быть рассеяны.</div><div class="content">Как только атакуемый город лишается средств обороны, ваши войска могут проникнуть туда и бороться против других сухопутных подразделений.</div><h2>После выбора города-цели на карте острова, вы можете предпринять следующие разновидности действий:</h2><div class="list">
                <ul>
...
<div class="content">Чтобы привлечь жителей для служения Богу, необходимо в городах построить <b>храмы</b> и нанять туда жителей из числа населения города. Каждый священник способен убедить пять жителей острова. Однако это требует не так много времени, люди Икариам очень набожные и легко убеждаемые.</div><div class="content">Правители, заинтересованные в мощных чудесах, должны вербовать 1/6 населения в священников!</div><div class="content">Чем больше становятся города на острове, тем больше сокращается влияние, оказываемое одним священником. Очень тяжело для правителя, удерживать планку верующих островитян на 100%! Ходят слухи о безрассудных правителях, угрожающих войной тем, кто не помогает в распространении веры.</div>        <div class="navigation">
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td width="50%" align="left">
